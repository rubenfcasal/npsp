      SUBROUTINE DGELSYR( M, N, NRHS, A, LDA, B, LDB, JPVT, RCOND, RANK,
     $                   WORK, LWORK, INFO )
*
...
*
*  -- Modified by
*  --   Fernandez-Casal, Mathematics Dept., Univ. of A Coru\~na, Spain  
*  --   June 2013
*
*     .. Scalar Arguments ..
...
*     R. Fernandez-Casal: B(1:N,1:NRHS) := Z**T * B(1:N,1:NRHS)
*
      IF( RANK.LT.N ) THEN
